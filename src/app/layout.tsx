...
export const metadata: Metadata = {
  ...
  description:
    "Advanced showcase of Rendering Strategies & Performance Patterns in Next.js 15+.",
  alternates: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description:
      "Advanced showcase of Rendering Strategies & Performance Patterns",
    url: "https://lab.badrigaire.com.np",
  };
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-sm text-zinc-500 max-w-xs leading-relaxed font-medium">
                Advanced Next.js 15 demonstration project focusing on
